...
async function callTimezoneLookupAPI() {
    try {
        ...
        const response = await fetch(`https://api.apiverve.com/v1/timezonelookup?${params}`, {
            method: 'GET',
            headers: {
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/timezonelookup](https://docs.apiverve.com/ref/timezonelookup)

---

## Use Cases

Common use cases for the Timezone Lookup API:
