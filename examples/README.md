# Timezone Lookup API - Examples

This folder contains example code for using the Timezone Lookup API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/timezonelookup',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/timezonelookup");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/timezonelookup](https://docs.apiverve.com/ref/timezonelookup)
